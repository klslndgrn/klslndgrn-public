...
class FileBrowser(GUI_prerequisite.Prerequisite):
    ...
    def __init__(self):
        ...
        self.outputBox = tk.Text(self.bottomFrame,
        ...
        self.plotAllButton = tk.Button(self.rightFrame,
                                       text="Show Grid Data",
                                       font=self.text_font,
                                       width=self.button_width,
                                       height=self.button_height,
        ...
        self.plotDetButton = tk.Button(self.rightFrame,
                                       ...
                                       bg='#99ccff',
                                       command=lambda:
                                           self.data_print('details'))
        self.plotDetButton.grid(row=5,
                                rowspan=1,
                                column=0,
                                pady=self.spacingY,
                                padx=self.spacingX,
...
class Input(InputRow):
    ...
    def browse_file(self, var, text):
        var.set(filedialog.askopenfilename(initialdir=".",
                                           title=text,
